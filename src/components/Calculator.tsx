...
export default function Calculator() {
  ...
  const themes = {
    1: {
      ...
      screenBg: "bg-[#182034]",
      numberKey:
        "bg-[#eae3dc] hover:bg-[#fffffe] text-[#444b5a] shadow-[0_4px_0_#b4a597]",
      functionKey:
        "bg-[#647198] hover:bg-[#a2b2e1] text-white shadow-[0_4px_0_#404e72]",
      equalsKey:
    ...
    2: {
      ...
      screenBg: "bg-[#ededed]",
      numberKey:
        "bg-[#e5e4e1] hover:bg-[#ffffff] text-[#35352c] shadow-[0_4px_0_#a69d91]",
      functionKey:
        "bg-[#378187] hover:bg-[#62b5bc] text-white shadow-[0_4px_0_#1b6066]",
      equalsKey:
    ...
    3: {
      ...
      screenBg: "bg-[#1d0934]",
      numberKey:
        "bg-[#341c4f] hover:bg-[#6c34ac] text-[#ffe53d] shadow-[0_4px_0_#871c9c]",
      functionKey:
        "bg-[#58077d] hover:bg-[#bc15f4] text-white shadow-[0_4px_0_#bc15f4]",
      equalsKey:
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className={`w-full max-w-lg mx-auto p-6 ${currentTheme.bg} rounded-lg`}
      >
        {/* Header */}
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-4">
            <span
              className={`text-xs font-bold tracking-widest ${currentTheme.textColor}`}
            >
              THEME
            </span>
            <div className="flex flex-col items-center">
              <div
                className={`flex gap-3 text-xs mb-1 ${currentTheme.textColor}`}
              >
                <span>1</span>
                <span>2</span>
                <span>3</span>
              ...
              <div
                className={`${currentTheme.keypadBg} rounded-full p-1 flex gap-1`}
              >
                {[1, 2, 3].map((t) => (
                  <button
                    key={t}
                    ...
                    className={`w-4 h-4 rounded-full transition-colors ${
                      theme === t
                        ? currentTheme.equalsKey.split(" ")[0]
                        : "bg-transparent"
                    }`}
                  />
                ))}
